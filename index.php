...
<head>
    <meta charset="UTF-8">
    <title>3n Host | Soluções de Redirecionamento</title>
    <link rel="stylesheet" href="assets/css/style.css">
</head>
<body>
    <nav class="nav">
        <h2>3n<span>Shortener</span></h2>
        <a href="login.php" style="color: var(--text-gray); text-decoration: none;">Painel Administrativo</a>
    </nav>
